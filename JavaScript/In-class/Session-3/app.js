...
//--------------------------------------------------------------
// ! example: three number comparison
...
let pathno = prompt(`Select your path: \n("ad": aws devops) \n("fs":  full-stack) \n("ds": data-science) `)
let pathInfo;
switch (pathno) {
  case "fs":
    console.log("Information about Full Stack Development")
    break;
 case "ad": 
    console.log("Information about AWS")
    break;
 case "ds": 
    console.log("Information about Data Science")
    break;
}